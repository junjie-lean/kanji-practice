...
export default function DarkModeToggle() {
    ...
    return (
        <button
            ...
            className="fixed top-4 right-4 z-50 p-3 rounded-lg bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700 group"
            aria-label="切换暗黑模式"
        >
            {darkMode ? (
                // 太阳图标（亮色模式）
